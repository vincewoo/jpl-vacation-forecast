                  ...
                  <tr key={vacation.id}>
                    ...
                    <td className="vacation-actions">
                      <button
                        ...
                        title="Edit vacation"
                        aria-label={`Edit vacation from ${formatDateDisplay(vacation.startDate)} to ${formatDateDisplay(vacation.endDate)}`}
                      >
                        Edit
                      </button>
                      <button
                        ...
                        aria-label={`Delete vacation from ${formatDateDisplay(vacation.startDate)} to ${formatDateDisplay(vacation.endDate)}`}
                      >
                        Delete
                      </button>
                    </td>
